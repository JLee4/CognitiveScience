...
public class Persona2 extends Persona {
    ...
    public static User createUser() {
        ...
        return new User(User.Mood.BORED, new FreeTime(2, 0), new Group(1, false, false), User.Attention.FULL, new ArrayList<>(), false, null, preferredGenres, new ArrayList<>(), 3, null);
    }
}
